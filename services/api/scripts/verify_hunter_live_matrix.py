...
CASES = [
    ...
    ("marketing_sul", "agências de marketing digital", "Curitiba - PR", ["web", "facebook"], 20),
    ...
    ("contabilidade_centro", "escritórios de contabilidade", "Goiânia - GO", ["google_maps", "web", "facebook"], 10),
