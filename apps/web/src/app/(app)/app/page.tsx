...
export default async function DashboardPage() {
  ...
  return <div className="space-y-7">
    <PageHeader title="Visão geral" actions={<RefreshWorkspace />} />
